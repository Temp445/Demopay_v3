...
type ReportSubtype =
  ...
  | 'monthly' | 'attendance' | 'leave' | 'overtime' | 'bonus' | 'loan' | 'payslip' | 'permissionBalance' | 'musterRoll' | 'timestampMismatch'
  ...
  return (
    <div className="xl:py-6">
      <div className="max-w-7xl mx-auto px-2 sm:px-6 md:px-8">
        ...
        {isFiltersOpen && (
          <div className="mt-4">
            <ReportFilters filters={filters} onFilterChange={setFilters} isRestricted={isRestricted} />
          </div>
        )}
                ...
                {reportType === 'transaction' && (
                  <>
                    ...
                    {canViewAllData && (
                      <button
                        className={`px-4 py-2 rounded-md text-sm font-medium ${
                          reportSubtype === 'permissionBalance'
                            ? 'bg-indigo-100 text-indigo-700'
                            : 'text-gray-700 hover:bg-gray-100'
                        }`}
              ...
              */}
              {!isReady ? (
                ...
                <>
                  ...
                  {reportType === 'transaction' && !['musterRoll', 'timestampMismatch'].includes(reportSubtype) && (
