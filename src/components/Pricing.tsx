...
const tiers = [
  {
    ...
    features: [
      ...
      'Shifts & Holidays Configuration',
      'Core Payroll Processing & Payslips',
  ...
  },
  {
    ...
    features: [
      ...
      'Permissions & Advance Tracking',
      'Overtime Management & Calculations',
      'Gate Pass & Travel Allowances',
  ...
  },
  {
    ...
    features: [
      ...
      'Biometric & Hik Device Integration',
      'Custom Formula Builder & Salary Structures',
      'Custom SMTP & Automated Notifiers',
