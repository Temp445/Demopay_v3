-- Migration: fix_office_arrival_entry_order
-- Description: Update fix_attendance_entry_order to prevent it from overwriting office arrival (IN Outside Office -> IN Office) punches.
