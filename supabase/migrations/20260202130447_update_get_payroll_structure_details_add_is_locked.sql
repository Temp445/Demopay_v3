/*
  # Update get_payroll_structure_details to Include is_locked

  1. Changes
    - Add is_locked field to the returned JSON object
    - This field comes from payroll_structure_components table

  2. Purpose
    - Allow frontend to retrieve the is_locked status for each component
    - Support displaying and managing the locked state in the UI
*/

-- Drop the existing function
DROP FUNCTION IF EXISTS get_payroll_structure_details(uuid, uuid);

-- Recreate with is_locked field
