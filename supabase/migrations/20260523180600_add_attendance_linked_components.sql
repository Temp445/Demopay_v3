...
-- 1. Drop the old function so we don't end up with duplicates
DROP FUNCTION IF EXISTS public.insert_pay_structure_component(
  numeric, text, text, uuid, text, text, boolean, numeric, text[], uuid, uuid, boolean, boolean, text, jsonb, integer
);
