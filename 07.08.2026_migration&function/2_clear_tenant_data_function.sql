...
DECLARE
  ...
  v_tables text[] := ARRAY[
    ...
    'outside_office_approvals',
    'attendance_comp_off_credits',
    'missed_punch_alerts',
    'missed_punch_notification_settings',
    ...
    -- PRESERVED: tenants, profiles, tenant_users, subscriptions, company_settings, application_screens, trial_cleanup_logs
  ];
BEGIN
