/*
  # Update get_payroll_structure_details Function

  1. Changes
    - Add is_attendance_linked and always_treat_as_full_day fields to the returned JSON

  2. Purpose
    - Ensure these fields are retrieved when loading salary structures for editing
*/
