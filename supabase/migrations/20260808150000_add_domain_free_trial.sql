...
-- 1. Add columns to domains_management
ALTER TABLE public.domains_management
ADD COLUMN IF NOT EXISTS free_trial_available boolean DEFAULT false,
ADD COLUMN IF NOT EXISTS free_trial_days integer DEFAULT 7,
ADD COLUMN IF NOT EXISTS trial_plan_name text DEFAULT 'Elite Trial';

-- 2. Update handle_new_user to use the free trial configurations
